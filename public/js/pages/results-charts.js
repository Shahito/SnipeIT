...
const exitReasonsChart = new BarChart('exitReasonsChart', 'exitReasonsFilters', {
  ...
  getLabel:  (k, d) => ({ title: { risk: 'TP/SL', signal: 'Signal', tsl: 'Trailing SL', end: t('results.exit_reasons.label_end') }[k], sub: t('results.exit_reasons.pct_of_trades', { pct: d.totalPct }) }),
...
let REASON_LABELS = _buildReasonLabels()
